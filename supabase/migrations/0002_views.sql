...
--
-- `security_invoker = true` matters here: a plain view runs as its owner and would
-- otherwise read straight past the RLS on the underlying tables.
...
create view v_submission_totals
